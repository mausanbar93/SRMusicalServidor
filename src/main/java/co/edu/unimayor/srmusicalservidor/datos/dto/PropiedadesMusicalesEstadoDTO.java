 ...
 * @date 5/04/2018
 */
public class PropiedadesMusicalesEstadoDTO {
    ...
    public PropiedadesMusicalesEstadoDTO() {
    }

    public PropiedadesMusicalesEstadoDTO(Integer id, Integer ranking, Integer semanas, Integer visualizacion, Double valoracion, String estado) {
        this.id = id;
